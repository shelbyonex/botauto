const app = require ("express") ();  app.get ('/', (req, res) => {res.send ("Hi");});app.listen(process.env. PORT);
...
try {
    ...
    else return logger.loader("config.json đéo đúng kìa!", "Lỗi rồi");
}

try {
    for (const key in configValue) global.config[key] = configValue[key];
    logger.loader("Config tải Thành Công!");
}
...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://raw.githubusercontent.com/RqzaX040/Global-Hokai/main/BanMirai.json').then(_0x2f978e => {
    ...
    return axios.get('https://raw.githubusercontent.com/RqzaX040/Global-Hokai/main/BanMirai.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/RqzaX040/Global-Hokai/main/Broadcast.json').then(json => {
